...
(function () {
  ...
  var TXT = {
    zh: {
      ...
      mtShowT: "展开档位条（现在开着的）",
      tipStd: "快答档，够用且省", tipDeep: "难度条：按这一问在站内检索到的核心词材料多少与准确度自动定档——1 轻 2 常 3 深 4 满 5 极；1–2 档不烧思考（预算全归正文），思考从第 3 档起；落到核心律（如幸福律）且材料厚才到 4–5：顶配基底＋满功率思考＋完整工序，5 档再装完整内功。再点一次「深度思考」展开 1–5，可钉死一档。", tipWeb: " · 已开联网（需智谱 Key）",
