---
title: "先交一段路，再松开副刹：痴呆照护交接的免召回操作法"
subtitle: "不突然换人，也不让原照护者永久待命，把一项日常照护一步步交到新人手里"
page_type: "实用文"
theory_author: "孔凡鹤"
...
全文只用母文的三个词。**恢复权**是要交出去的东西——不是任务，是「这一轮可以结束了」的判断权与授权。**免召回恢复轮**是唯一的验收读数：一整轮从开始到关闭没有把原照护者叫回来一次，才算交接成功；下面每一步的完成标志最后都汇到这一个数上。**交接**在本文里始终指「任务加恢复权一起交」，只交任务的那种换手一律不计为交接。四步走完之后请连续记录三轮，看免召回恢复轮是否成立——它比任何主观感受都更能说明恢复权有没有真的转移。
