---
title: "先感后看：外部数据与身体判断的双通道校准法"
subtitle: "一套可用于个人健康设备、训练反馈与产品界面的延迟、记录、比对和安全分级流程"
page_type: "实用文"
theory_author: "张琼"
...
sibling_path: "/students/zhang-qiong/recognitive-autophagy/interpretation/"
sibling_label: "诠释文"
is_practice: true
---
...
**红级**是即时安全信息：设备提示严重心律异常、血糖危险值、跌倒、急性缺氧，或医生要求即时响应的指标。红级直接显示并处置，不设置任何“先感后看”门槛。

**黄级**是需要专业解释但通常不构成即时危险的信息：持续异常趋势、训练负荷过高、慢病指标偏离。可以先记一行体感，但不能用体感否定数据；按既定规则咨询医生或教练。

**绿级**是适合训练的低风险反馈：睡眠主观质量、一般疲劳、日常压力、冥想走神、散步强度、普通恢复感。双通道练习主要放在绿级。
...
- 睡眠：眼皮轻，后脑发木，身体想继续躺，情绪不烦。
- 压力：呼吸浅但均匀，胸口紧两成，手不抖，注意容易跳。
- 训练：大腿酸而不痛，步频自然，转弯时膝盖无不稳。
- 冥想：清醒，念头多，能发现走神，肩膀逐渐松。
