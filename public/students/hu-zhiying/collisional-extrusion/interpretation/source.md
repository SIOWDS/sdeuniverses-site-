---
title: "很多新东西，不是设计出来的，而是两股力量挤出来的"
subtitle: "用揉面、合租、交通路口和组织冲突，读懂《碰撞逼出》"
page_type: "诠释文"
theory_author: "胡志英"
...
sibling_path: "/students/hu-zhiying/collisional-extrusion/practice/"
sibling_label: "实用文"
...
母文把这套机理称为**碰撞逼出**。关键词不是“碰一下”，而是差异、不可绕过、临界失效、新结构和锁定。它可以帮助我们理解物理学中的某些发生结构，也能作为严格受限的类比，观察自我、关系和制度怎样成形。
...
第一是**差异倾向**。双方不是已经完成的实体，而是朝不同方向形成的势头。创业团队的“快速上线”和合规部门的“先证明安全”，都不是固定人格，而是各自任务、奖励和风险位置形成的倾向。

第二是**不可绕过的对抗**。两股倾向必须争用同一资源、时间、空间或解释权。若能各自运行，只有并存，没有逼出。

第三是**临界失效**。旧安排靠加班、协调、例外或沉默维持，成本持续上升，直到某个环节不能再承担。临界点不是冲突最响的一刻，而是旧条件失去继续复制自己的能力。

第四是**新结构锁定**。系统形成新的接口、规则、身份或默认动作，并在重复中稳定。若争吵后第二天一切照旧，只是能量释放，不算结构生成。
