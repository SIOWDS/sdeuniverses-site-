---
title: "雾里看不见路，为什么先不走错也能长出方向？"
subtitle: "用登山者排除危险岔路的过程，理解无向抵抗如何在过渡期保存新线索"
page_type: "诠释文"
theory_author: "黄倩盈"
...
sibling_path: "/students/huang-qianying/undirected-resistance/practice/"
sibling_label: "实用文"
---

> 文章以雾中登山为主类比，区分暂时负向筛选与回避、冻结和逢事反对，并给出时间、证据和安全边界。

## 从一个日常场景说起
大雾里看不到山顶，登山者却能听见塌方、摸到湿滑石面，知道三条岔路不能走。

这个场景的关键不在雾中登山者手里的危险路标好不好，而在它与现场之间是否还保留来回校正。只要一次失败仍能改变下一步，工具就在服务生活；当失败只能被解释成“使用者不够标准”，方向就反了。母文把无向抵抗放在这里观察，也就是说，旧框架失去可信度、新方向尚未形成时，人可能只能知道哪些出口是假的；这种没有正向方案的拒绝可以暂时保护新方向不被仓促替代。
...
## 它原先确实帮人解决过问题
清楚路线能节省时间、协调队伍并在危险中救命，正向方案通常是行动所必需。

先承认旧办法的功劳，才能找到它真正反转的位置。雾中登山者手里的危险路标让大量陌生人能够合作，也降低了每次从头摸索的成本。若把一切问题都归咎于规则、模型或标准，就解释不了为何有些高度标准化的现场仍能保持活判断。真正的分水岭不是工具多少，而是工具有没有一个自己无法收买的校准者。
...
## 转折发生在工具不再接受外部纠正时
转折在旧地图已被现场否定，制度仍只承认立即报出新路线，伪答案因格式需要而出现。

反转并非某天突然宣布，通常是许多合理小动作累积的结果：为了公平而统一，为了效率而缩短，为了可比而编码，最后现场只能用编码证明自己。此时雾中登山者手里的危险路标仍沿用原来的名称，功能却从指路变成终点。判断反转应看错误能否穿过记录系统，回头改动规则，而不是看规则写得多精细。
...
## 第一处变化藏在判断入口
入口从哪些线索仍可信变成你到底要往哪走，尚未结成方向的材料被当作无用。
...
## 第二处变化出现在动作顺序
人先排除会重复旧失败的出口，保留反常细节，再等待不同线索产生可追踪关系。
...
## 第三处变化让旧办法开始自我维持
若每次拒绝都被奖励为清醒，无向状态也会自我维持；所以负向判断必须留下依据和期限。
...
## 看似相同的结果可能来自相反过程
同样没有方案，一人持续保存并更新线索，另一人只是回避决定；行为读数可以分开两者。
...
## 最容易误判的是把熟练当成真正拥有
擅长批评不等于形成方向，真正拥有表现在新线索出现时能修订排除表并尝试小步。
...
## 与最近的说法相邻但不相同
消极能力说明忍住结论，母文再赋予负向筛选、线索保存和方向形成的可观察次序。

最近的既有说法是济慈所说的消极能力。它已经能解释人在不确定与怀疑中停留，不急于用现成结论解除焦虑，但本文另切一层：无向抵抗强调负向筛选的操作性：它保存哪些假出口被排除、依据是什么，并等待线索逐步形成方向。可分离判据是，若改变旧理论指出的因素后现象立即消失，本文无需另立；若那些因素已改善，而在旧框架失效后，允许有期限的负向记录比立即要求方案更少产生伪答案，并更可能形成来自新线索的后续方向仍稳定出现，就说明还有一个独立环节需要命名。
...
## 回到这个日常场景
危险路标不能告诉人山顶在哪，却能保护队伍不被假出口耗尽，并为雾散后的判断保留位置。

再看大雾遮住山路，登山者还看不见正确方向，却凭塌方声、湿滑石面和旧标记知道三条岔路不能走；先不走错为新线索赢得时间，新的分辨是“完成任务”与“接受现场审判”并非一回事。前者可以靠熟练路线抵达，后者要求路线随地面变化而改变。雾中登山者手里的危险路标仍可保留，但必须允许一次真实碰撞把它改写。这样，类比带回的不是反工具口号，而是一条朴素判据：谁能在结果不合时迫使规则退让。
...
## 把类比再推一步
组织若只收正向提案，会逼人把微弱线索包装成熟方案，随后又用失败证明探索无用。
...
## 再划一条能被观察的分界线
探索框架比较现成选项，母文关注连选项都未成形时，怎样避免把旧分支冒充新路。

另一个相邻说法是探索与利用的决策框架。它关注在未知环境中怎样分配资源于尝试新选项和使用已知优选项，本文则关注母文讨论的是可用选项本身尚未成形的阶段，此时主要能力不是多试几个现成分支，而是拒绝伪出口并保存微弱线索。两者可以同时成立，却会给出不同预测：前者改善后若在旧框架失效后，允许有期限的负向记录比立即要求方案更少产生伪答案，并更可能形成来自新线索的后续方向随之下降，可用旧说法解释；若它在相同条件下持续，甚至因工具更精细而增强，母文的分界才真正站住。划界的目的不是争夺新词，而是防止用错修复方向。
...
## 这项判断有明确的适用边界
紧急情况、明显冻结与有关键证据可查时不能停在无向状态，应优先行动或求助。

这项判断只适用于创作、研究、职业转向和组织探索中旧方案已被证据否定、又没有急迫安全决策的过渡阶段，不能扩张成对一切规则和中介的否定。紧急救援、法定决定、可以收集关键证据却持续回避、抑郁或创伤冻结，以及已有可行方案却拒绝行动就是重要反例：那里即使工具密集，参与者仍能被共同后果校正，因此工具与能力可以一起成长。边界要求我们同时看后果硬度、反馈是否有信息、参与者能否承担并修正规则，缺少其中一项都不能草率下结论。
...
## 它不能被这样误用
不能把逢事反对包装成深度；每个不走都要有现实依据、复查日期和转向小试验的条件。

它不主张浪漫化瘫痪、赞美反对一切、拒绝求助、拖延必要决定，或把没有方案当成道德优越，也不能被权力更大的一方拿去要求别人“多承担真实后果”。合理保护、公平程序和专业标准仍然必要；真正要防的是保护与标准把修正通道一并封死。若长期观察发现立即要求正向方案在相同条件下不增加伪答案且更快产生稳定方向，负向记录从不贡献任何新线索，核心判断就应被削弱或撤回。一个只会把反例重新解释成支持材料的理论，与它所批评的封闭工具没有区别。
