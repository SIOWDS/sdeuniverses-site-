---
title: "老师给的路线越清楚，学生为什么划得越费劲？"
subtitle: "用一条横向拉船的牵引绳，理解教学方向与学习方向错位时力量怎样被耗散"
page_type: "诠释文"
theory_author: "黄倩盈"
...
sibling_path: "/students/huang-qianying/medium-damping/practice/"
sibling_label: "实用文"
---

> 文章以独木舟牵引绳为主类比，区分知识难度、支持强度与方向错位，也说明降低阻尼不是取消教学或放弃共同基础。

## 从一个日常场景说起
划手一直用力，船也在前进，可大半力量都在抵消岸上横拉的绳，疲惫被误读成不肯学。

这个场景的关键不在河面上拽住独木舟的牵引绳好不好，而在它与现场之间是否还保留来回校正。只要一次失败仍能改变下一步，工具就在服务生活；当失败只能被解释成“使用者不够标准”，方向就反了。母文把介质阻尼放在这里观察，也就是说，教学的预设路线若与学习者已经形成的认知方向不一致，会把原本能推进理解的力量消耗在对抗、绕行和表面配合上。
...
## 它原先确实帮人解决过问题
地图和牵引能帮助初学者避开危险、掌握公共航道，也能在迷路时提供明确支点。

先承认旧办法的功劳，才能找到它真正反转的位置。河面上拽住独木舟的牵引绳让大量陌生人能够合作，也降低了每次从头摸索的成本。若把一切问题都归咎于规则、模型或标准，就解释不了为何有些高度标准化的现场仍能保持活判断。真正的分水岭不是工具多少，而是工具有没有一个自己无法收买的校准者。
...
## 转折发生在工具不再接受外部纠正时
转折不是绳子出现，而是它不再接受水流与船身反馈，只允许所有船朝同一角度。

反转并非某天突然宣布，通常是许多合理小动作累积的结果：为了公平而统一，为了效率而缩短，为了可比而编码，最后现场只能用编码证明自己。此时河面上拽住独木舟的牵引绳仍沿用原来的名称，功能却从指路变成终点。判断反转应看错误能否穿过记录系统，回头改动规则，而不是看规则写得多精细。
...
## 第一处变化藏在判断入口
入口从学习者正在追哪个问题变成课程下一格是什么，原有方向尚未被读出便被拉直。
...
## 第二处变化出现在动作顺序
学生先翻译老师路线、压住自己的疑问、完成标准动作，剩余精力才用来理解材料。
...
## 第三处变化让旧办法开始自我维持
表面进度证明牵引有效，教师因而加大说明；方向差没有记录，摩擦继续被解释成能力不足。
...
## 看似相同的结果可能来自相反过程
同样完成任务，一人顺着问题建立结构，另一人靠持续抵消完成；撤绳后的新河段会把两者分开。
...
## 最容易误判的是把熟练当成真正拥有
熟练复述路线不等于形成方向，真正拥有表现为条件变化后能从问题重新导航。
...
## 与最近的说法相邻但不相同
认知负荷解释容量压力，母文再加入方向夹角，指出信息不多也可能因横向牵引而耗散。

最近的既有说法是认知负荷理论。它已经能解释任务结构与教学呈现怎样占用有限工作记忆，并区分必要负荷和无关负荷，但本文另切一层：介质阻尼不只看负荷多少，还看教学推进方向与学习者已有问题方向的夹角，低负荷的错误牵引也会持续耗散。可分离判据是，若改变旧理论指出的因素后现象立即消失，本文无需另立；若那些因素已改善，而控制信息量、难度和时间后，方向错位越大，学习者的绕行解释、表面配合和撤除支持后的迷失越明显仍稳定出现，就说明还有一个独立环节需要命名。
...
## 回到这个日常场景
牵引绳仍可救急，新的判据是它能否根据船、水流和划手反馈改变角度并逐渐松开。

再看独木舟本来顺着支流水势探索，岸上的人按地图向另一处拉绳；船没有停，划手却把大半力气用来抵消侧向拉扯，新的分辨是“完成任务”与“接受现场审判”并非一回事。前者可以靠熟练路线抵达，后者要求路线随地面变化而改变。河面上拽住独木舟的牵引绳仍可保留，但必须允许一次真实碰撞把它改写。这样，类比带回的不是反工具口号，而是一条朴素判据：谁能在结果不合时迫使规则退让。
...
## 把类比再推一步
若课程只记录到达节点，不记录绕行和抵消，越精细的路线图越可能遮住真实耗费。
...
## 再划一条能被观察的分界线
脚手架说明适度支持，母文另问支持是否与学习者正形成的问题方向对齐。

另一个相邻说法是脚手架与最近发展区理论。它关注适度支持怎样让学习者完成暂时无法独立完成的任务并逐步撤除帮助，本文则关注母文先要求辨认学习者正在朝哪里生成问题，支持若方向错位，即使强度适度也可能变成阻尼。两者可以同时成立，却会给出不同预测：前者改善后若控制信息量、难度和时间后，方向错位越大，学习者的绕行解释、表面配合和撤除支持后的迷失越明显随之下降，可用旧说法解释；若它在相同条件下持续，甚至因工具更精细而增强，母文的分界才真正站住。划界的目的不是争夺新词，而是防止用错修复方向。
...
## 这项判断有明确的适用边界
没有基本知识、涉及安全或学习者尚无可辨方向时，清楚引导仍然必要。

这项判断只适用于课堂教学、导师指导、培训和低风险知识工作中学习者已有可辨认问题方向的场景，不能扩张成对一切规则和中介的否定。初学者尚无方向、必须掌握安全基础、明显知识缺口以及教师路线与学习方向一致的场景就是重要反例：那里即使工具密集，参与者仍能被共同后果校正，因此工具与能力可以一起成长。边界要求我们同时看后果硬度、反馈是否有信息、参与者能否承担并修正规则，缺少其中一项都不能草率下结论。
...
## 它不能被这样误用
不能把降低阻尼变成教师退场，也不能把任何抗拒都美化成独特方向；方向必须以材料推进接受检验。

它不主张教师永远不引导、学习者想走哪就走哪、取消共同知识，或把所有困难归咎于教学，也不能被权力更大的一方拿去要求别人“多承担真实后果”。合理保护、公平程序和专业标准仍然必要；真正要防的是保护与标准把修正通道一并封死。若长期观察发现控制认知负荷和先备知识后，方向夹角不预测任何额外困难，而且强牵引始终同等提高迁移与自主判断，核心判断就应被削弱或撤回。一个只会把反例重新解释成支持材料的理论，与它所批评的封闭工具没有区别。
