...
这个场景的关键不在窗台上总向亮处弯曲的花盆好不好，而在它与现场之间是否还保留来回校正。只要一次失败仍能改变下一步，工具就在服务生活；当失败只能被解释成“使用者不够标准”，方向就反了。母文把向评性与向生性放在这里观察，也就是说，当分数、认证和展示成为最强光源，学习会在自己尚未察觉时整体转向可被看见的方向，而不再沿着问题本身生长。
...
先承认旧办法的功劳，才能找到它真正反转的位置。窗台上总向亮处弯曲的花盆让大量陌生人能够合作，也降低了每次从头摸索的成本。若把一切问题都归咎于规则、模型或标准，就解释不了为何有些高度标准化的现场仍能保持活判断。真正的分水岭不是工具多少，而是工具有没有一个自己无法收买的校准者。
...
反转并非某天突然宣布，通常是许多合理小动作累积的结果：为了公平而统一，为了效率而缩短，为了可比而编码，最后现场只能用编码证明自己。此时窗台上总向亮处弯曲的花盆仍沿用原来的名称，功能却从指路变成终点。判断反转应看错误能否穿过记录系统，回头改动规则，而不是看规则写得多精细。
...
== 第二处变化出现在动作顺序
人先预测评委，再选择可展示的问题，随后组织证据，最后删去不能转换成成果的迂回。
...
== 第三处变化让旧办法开始自我维持
可展示成果更容易获得资源，资源又证明朝向评价是理性选择，未被比较的生长因此越来越少。
...
== 看似相同的结果可能来自相反过程
同样高质量的作品可能来自向评优化，也可能来自问题推进；撤掉展示机会后是否仍继续，能把两条路径分开。
...
== 与最近的说法相邻但不相同
成就目标定向研究解释了掌握目标与表现目标怎样影响动机、策略和坚持，但母文把分析单位从个体动机移到个体、制度与资源共同偏转的生态朝向，并关注元标准被改写。

最近的既有说法是成就目标定向研究。它已经能解释掌握目标与表现目标怎样影响动机、策略和坚持，但本文另切一层：母文把分析单位从个体动机移到个体、制度与资源共同偏转的生态朝向，并关注元标准被改写。可分离判据是，若改变旧理论指出的因素后现象立即消失，本文无需另立；若那些因素已改善，而取消展示、认证与兑换接口后，一部分探索仍沿事物逻辑继续，而仅靠表现目标的任务明显降温仍稳定出现，就说明还有一个独立环节需要命名。
...
再看一盆幼苗本来四面伸展，家人把奖状灯一直放在右侧，叶片日复一日全朝那边弯；没人命令它转向，光源的位置已经决定了生长姿态，新的分辨是“完成任务”与“接受现场审判”并非一回事。前者可以靠熟练路线抵达，后者要求路线随地面变化而改变。窗台上总向亮处弯曲的花盆仍可保留，但必须允许一次真实碰撞把它改写。这样，类比带回的不是反工具口号，而是一条朴素判据：谁能在结果不合时迫使规则退让。
...
== 再划一条能被观察的分界线
古德哈特定律与反应性测量关注指标成为目标后为何失真，以及被测者怎样回应测量，母文另指出这里还追踪指标如何在行动前塑造什么值得成为问题，而不只解释已有行为怎样迎合指标。

另一个相邻说法是古德哈特定律与反应性测量。它关注指标成为目标后为何失真，以及被测者怎样回应测量，本文则关注这里还追踪指标如何在行动前塑造什么值得成为问题，而不只解释已有行为怎样迎合指标。两者可以同时成立，却会给出不同预测：前者改善后若取消展示、认证与兑换接口后，一部分探索仍沿事物逻辑继续，而仅靠表现目标的任务明显降温随之下降，可用旧说法解释；若它在相同条件下持续，甚至因工具更精细而增强，母文的分界才真正站住。划界的目的不是争夺新词，而是防止用错修复方向。
...
这项判断只适用于学校、培训和低风险创新项目中，评价预期提前改变问题选择与思考方向的场景，不能扩张成对一切规则和中介的否定。法定考试、基本能力认证、必要安全考核以及机会分配必须公开审查的场景就是重要反例：那里即使工具密集，参与者仍能被共同后果校正，因此工具与能力可以一起成长。边界要求我们同时看后果硬度、反馈是否有信息、参与者能否承担并修正规则，缺少其中一项都不能草率下结论。
...
== 它不能被这样误用
不能用向生性替低质量和特权开脱，也不能暗中观察后再把材料纳入选拔；接口必须真正断开。

它不主张取消一切评价、否定公平选拔、把不完成浪漫化，或让有资源者垄断不受监督的自由，也不能被权力更大的一方拿去要求别人“多承担真实后果”。合理保护、公平程序和专业标准仍然必要；真正要防的是保护与标准把修正通道一并封死。若长期观察发现切断展示兑换后探索质量和持续性从不改变，且所有所谓向生行为都能被表现目标完整解释，核心判断就应被削弱或撤回。一个只会把反例重新解释成支持材料的理论，与它所批评的封闭工具没有区别。
