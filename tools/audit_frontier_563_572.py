#!/usr/bin/env python3
"""Full V7 batch acceptance test for Frontier panels 563--572."""
...
TARGETS = {
    563: "climate-tech",
    564: "carbon-capture-utilization-storage-removal",
    565: "hydrogen-science-engineering",
    566: "smart-grids-integrated-energy-systems",
    567: "renewable-energy-engineering",
    568: "circular-economy-industrial-ecology",
    569: "computational-sustainability",
    570: "climate-resilient-infrastructure",
    571: "sustainable-construction-design-for-disassembly",
    572: "urban-informatics-city-digital-twins",
}
...
def main() -> None:
    ...
    assert "已发布 <b>42</b> 块，规划中 <b>8</b> 块" in hub
    assert "第五期已发布第 531–572 号，共 42 块" in hub
    seventh_done = [
