...
SLUG = {'出版信息': 'pub', '作者介绍': 'au', '前言': 'qy', '导读': 'dd', '导论': 'dl',
        '十二种读法': 'tj', '十句': 'sj', '枢纽章': 'sn', '合章': 'hz', '参考文献': 'ref'}
...
idx = (f'<!DOCTYPE html><html lang="zh"><head><meta charset="utf-8">'
       ...
       f'<div class="meta">{SUB} · 王德生 ＋ Claude 著 · 十二种读法·前言·导读·导论·四编十章·枢纽章·合章·结语·参考文献·三附录·后记·十句 · {WAN} · {PAGES_N} · 德麦国际专著第 {NO} 号</div>'
