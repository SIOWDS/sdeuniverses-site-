...
PAPERS = [{
    "slug": "defensive-sedimentation",
    "src": Path("/home/claude/confluence/defensive-sedimentation.md"),
    "title": "理论的边界是被打出来的",
    "sub": "论长期争议中理论范围的防守性重划及其可检验判据",
    "cross": "精神病学 × 演化生物学 × 经济学",
    "no": "之三",
    "deck": ("一个理论遭遇不利证据时还有第三条路：不改内容、不质疑实验，而是重新说明自己原本主张的范围。"
             "本文考察三场仍在进行的争论——抑郁症的血清素假说、演化生物学的扩展综合、"
             "经济学中理性假设与行为发现的关系——发现三者的核心分歧都不在世界怎样，"
             "而在「我们的理论究竟主张过什么」。防守分两个相反方向："
             "收缩型（我们从未主张过那么强的版本）与扩张型（这些新现象早已被我们容纳）；"
             "方向相反而功能相同。长期重划的累积结果是一个没有人设计的形状——"
             "恰好包住全部已知事实、恰好排除全部已知反例；而它「看起来极为成功」"
             "与「不再可被检验」是同一件事的两面。"),
    "clash": ("第一场里防守方往回收（那个被推翻的强版本我们从未主张），"
              "第二场里防守方往外扩（这些新现象不是错的，只是不必要，可作附加项纳入），"
              "第三场里同一批人同时使用了两个方向相反的防守——"
              "被指与心理证据不符时说理性从来不是心理主张，被指容纳不了时说这些都可以被建模。"),
    "sources": [
        ("精神病学 · 抑郁症病因学",
         "血清素假说之争 —— 2022 年伞状综述（Molecular Psychiatry）与三十六位研究者的联名评论",
         "https://www.nature.com/articles/s41380-022-01661-0",
         "综述称六个主要研究领域均无一致证据；防守方称该理论从未主张单一化学物质失衡，"
         "而是作为可能解释某些药物如何起效的脑改变之一例。典型的收缩型防守。"),
        ("演化生物学 · 演化理论的结构",
         "现代综合论对阵扩展演化综合 ——《Nature》2014 年正面交锋及其后续",
         "https://www.nature.com/articles/514161a",
         "反对方的核心论证不是这些观点错误，而是它们并不必要——"
         "发育偏向、生态位建构、表观遗传可被视为对既有框架的附加项。典型的扩张型防守。"),
        ("经济学 · 理性假设与行为发现",
         "工具性假设立场与参数化吸收 —— 两种方向相反的防守在同一场争论中叠合",
         "https://www.ssrn.com/abstract=4046264",
         "一条防守称理性从来是工具性建模假设而非心理描述（收缩）；"
         "另一条称行为偏离均可被写入效用函数与贴现形式（扩张）。两条各自成立而互不相容。"),
    ],
}]
