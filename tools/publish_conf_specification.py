...
PAPERS = [{
    "slug": "three-way-specification",
    "src": Path("/home/claude/conf56.md"),
    "title": "换一种说法，它就不见了",
    "sub": "论知识学习的本质不在内部组织、可测表现或所嵌条件的任何一项，而在三者被系成一个可复现的组合，及解绑代价何以在全部合格指标下不可见",
    "cross": "教育学 × 化学 × 管理学",
    "no": "之五十八",
    "deck": ("知识学习的本质是什么？三门学科各给一个单维答案，且各自认为自己那一维单独够用。"
             "认知负荷与图式理论说，看它在长时记忆里被组织成什么样就够了——长时记忆若无变化便无学习；"
             "化学的结构确证规程说，看它在标准条件下测出什么就够了——测不出的不构成同一性判据；"
             "组织理论的实践派说，看它嵌在什么条件上就够了——取出来就不是它。"
             "三条互不相容，却共有一个从未说出的假定：**知识是一样有内在同一性的东西，"
             "因而这是不是同一份知识有一个由某一维单独给出的答案**。"
             "推翻它的材料来自化学自己——**多形性**：同一分子式、同一连接方式，"
             "不同晶型下溶解度与生物利用度可以完全不同；而消失的晶型更进一步，"
             "新晶型一旦出现，旧晶型可能在同一套工艺上再也做不出来。"
             "化学为此把固态形式写进了同一性判据——它自己早已承认，这是什么没有任何一维能单独回答。"
             "由此本文提出**三联指定**：一份知识的同一性由内部组织、可测表现与所绑条件场三者联合给出，"
             "缺一项不是难以回答，是没有答案。学习因此不是获得一样东西，而是**完成一次绑定**。"
             "配套读数**解绑代价**与**绑定宽度**在三领域量纲不同而比率相同，且与既有指标正交——"
             "一个正确率满分、速度最快的学生，换一种表述就完全做不出来，其解绑代价接近于重学。"
             "文中另论证：一门同时持有「图式可脱离情境调用」与「变式效应」两条主张的学问，"
             "在不承认本文变量时无法自洽。"),
    "clash": ("第一家主张学习的本质是长时记忆中图式的建构与自动化，表现只是读数、情境只是需要被跨越的表面特征；"
              "第二家主张一样东西是什么由标准条件下测出的那组特征唯一确定，测不出的不进入判据；"
              "第三家主张知不是可被拥有与转移的东西，它在实践中被反复做出来，取出来便不是它。"
              "三家不能同为真，且各自的日课正是另一家诊断出的病："
              "去情境化在实践派看来正是抽空知识的动作；"
              "拒绝形式化在结构确证的规程看来等于放弃了被确认为同一对象的资格；"
              "而标准条件在图式论看来最不能说明问题——标准条件下的良好表现完全可能来自尚未进入长时记忆的临时通路。"),
    "sources": [
        ("教育学 · 认知负荷与图式理论",
         "Sweller, van Merriënboer &amp; Paas, Cognitive Architecture and Instructional Design: 20 Years Later "
         "(<i>Educational Psychology Review</i> 31:2, 2019)；其效应清单中的变式效应见 "
         "Paas &amp; van Merriënboer, <i>Journal of Educational Psychology</i> 86:1 (1994)",
         "https://doi.org/10.1007/s10648-019-09465-5",
         "主张所有新信息先经容量有限的工作记忆再存入长时记忆，故长时记忆若无变化便无学习；"
         "而这一支自己确立的变式效应表明，同等总量的练习分布在多个表面特征上迁移更好——"
         "这说明图式带着它被建构时的条件，并不像该纲领所设想的那样可脱离情境。"),
        ("化学 · 多形性、固态形式与消失的晶型",
         "Bauer et al., Ritonavir: An Extraordinary Example of Conformational Polymorphism "
         "(<i>Pharmaceutical Research</i> 18:6, 2001)；另见 Ritonavir Form III: A Coincidental Concurrent Discovery "
         "(<i>Crystal Growth &amp; Design</i> 23:1, 2023)；Turner et al., <i>Molecular Pharmaceutics</i> (2024)",
         "https://pubmed.ncbi.nlm.nih.gov/11474792/",
         "同一分子式与同一连接方式，在不同晶型下溶解性质显著不同，1998 年曾导致一种抗艾滋病药物撤市近一年；"
         "化学因此把固态形式写进同一性判据——这一条正是推翻共有前提的材料，"
         "而它在化学里回答的是药物工艺与专利问题。"),
        ("管理学 · 实践中的知与集体能力",
         "Orlikowski, Knowing in Practice: Enacting a Collective Capability in Distributed Organizing "
         "(<i>Organization Science</i> 13:3, 2002)；另见 Cook &amp; Brown, Bridging Epistemologies "
         "(<i>Organization Science</i> 10:4, 1999)；Brown &amp; Duguid, <i>Organization Science</i> 2:1 (1991)",
         "https://doi.org/10.1287/orsc.13.3.249.2776",
         "主张知不是可被拥有、储存与转移的资产，而是在具体实践中被持续做出来的集体能力；"
         "而这一支自己长期研究实践如何在不同场所之间被复制与调适——"
         "那个研究对象若真不可取出便不存在，故它实际处理的从来是取出要付多少代价。"),
    ],
}]
