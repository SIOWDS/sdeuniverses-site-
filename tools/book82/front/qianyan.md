...
张琼反过来为完成品辩护：那些被误认为死掉的硬壳，不是生命的残余，是伦理能够跨越一次次肉身死亡、在断裂带上仍然保持可传递性的**唯一的**骨骼。
...
**第二处**：我原来打算把书名叫作与"消失"有关的什么词。第十章拦住了。她让我看见，这里真正难的不是消失，是**两种状态的不可分辨**——被激活的骨骼和被供奉的异体，从外面看完全一样。难题不在损失，在读数。
