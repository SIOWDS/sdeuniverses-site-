...
from batch2_meta import PAPERS, STUDENTS, PUBDATE_CN
from batch2_supp import SUPPLEMENTS, REFERENCES
...
# ("源篇号", 类型, 锚, 替换)
CLEANUP = []   # 本批无需逐句清理；改姓与增补承担全部提升工作
...
def main():
    ...
    (ROOT / "tools" / "batch2_report.json").write_text(json.dumps(
