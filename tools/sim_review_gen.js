...
ok("Skill 是 v1.7 且含⑦之二共识／⑧之三最小模型／⑨之三全量安装／⑨之四新路／R-48／§10 未来方向，并含⑤之二两道＋操作性饱和、⑧之二维度碰撞、典范判据、⑨之二新研究领地＋反土地四击、⑩之二 SDE 改姓、R-41", /version:\s*1\.7\.1\b/.test(SKILL) && SKILL.indexOf("工序⑤之三 体检闸") > 0 && SKILL.indexOf("R-55") > 0 && SKILL.indexOf("资历击") > 0 && SKILL.indexOf("工序⑦之二 共识闸") > 0 && SKILL.indexOf("工序⑧之三 最小模型算子") > 0 && SKILL.indexOf("工序⑨之三 全量安装") > 0 && SKILL.indexOf("工序⑨之四 新路发生") > 0 && SKILL.indexOf("R-48") > 0 && SKILL.indexOf("未来方向与分年目标") > 0 && SKILL.indexOf("工序⑩之二 SDE 改姓") > 0 && SKILL.indexOf("操作性饱和") > 0 && SKILL.indexOf("反土地四击闸") > 0 && SKILL.indexOf("R-41") > 0 && SKILL.indexOf("候选发生挑战与核心五条") > 0 && SKILL.indexOf("工序⑨之二 新研究领地发生") > 0 && SKILL.indexOf("典范判据") > 0 && SKILL.indexOf("工序⑤之二 敌拓闸") > 0 && SKILL.indexOf("第二道：按读数形状查对象词") > 0 && SKILL.indexOf("工序⑧之二 SDE 维度碰撞") > 0 && SKILL.indexOf("学科内") > 0);
  /* v1.4：⑧之二 学科内维度碰撞 */
  ...
  ok("页面自检 41 项（v1.7.1 加三项）", PG.indexOf("自检 41 项") > 0 && (PG.match(/out\.push\(\{n:/g) || []).length === 41);
