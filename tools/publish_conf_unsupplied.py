...
PAPERS = [{
    "slug": "unsupplied-capacity",
    "src": Path("/home/claude/conf49.md"),
    "title": "没有人在养它",
    "sub": "论一类不由任何一方生产、只由别处的低效活动顺带养成的能力，及它停止被养成时为何不产生任何事件",
    "cross": "经济学 × 艺术学 × 工程学",
    "no": "之四十九",
    "deck": ("同一个问题换一组理论来源再问一次。经济学取不完全契约与剩余控制权，艺术学取能动性推断与观看技能的历史性，"
             "工程学取「编程即理论建构」。三家给出三条互不相容的解释，各自指认了一个不同的持有者——"
             "资产的所有者、观看的一方、建造的人。三家共有一个没说出口的前提：那样要紧的东西总归被某一方持有着。"
             "推翻它的材料来自艺术学自己——观看的技能由与艺术无关的日常实践顺带养成，因此不由任何人持有。"
             "由此提出一类三家账本上都没有名分的东西：无供给品，被普遍依赖却不由任何一方生产的能力；"
             "它不因使用而减少，只因养成它的那些低效活动被逐一优化掉而消失，且消失不产生任何事件。"
             "判断是：这一轮的困境不是竞争加剧、不是判据迁移、不是瓶颈转移，而是能力正在停止被养成，"
             "于是所有人只能用可以被生产的量，去补一个不可以被生产的缺口。"
             "两处外来证据把它削得很重：住院医师工时改革的两项随机对照试验并未显示能力下降，"
             "把适用范围缩到「唯一养成源」；民航的手动飞行恢复证明衰退可以被逆转，"
             "把处方从「保留低效活动」改成「先建立能把能力衰退倒查到某项活动的调查制度」。"
             "文中另说明本文与本栏同题五篇的分工：那五篇的缺口都在记录侧，本文的缺口在生产侧。"),
    "clash": ("第一家主张任何合约都写不全，因此决定投资与效率的是当合约沉默时谁有权决定；"
              "第二家主张一件东西之所以起作用，靠的是观者从它身上倒推出制作的能动性，而这项推断技能"
              "由与艺术无关的日常实践养成；第三家主张一个系统真正的所在是建造者头脑中那套无法被外化的理论，"
              "代码与文档只是它的不完整投影，持有理论的人散掉，系统就只能被重写不能被修改。"
              "三家指认的持有者互不相同，因而不能同为决定项——而各自的日课正是另一家诊断出的病："
              "把关键资源变成可转让的权利（经济）是艺术判定的病根，从产物倒推制作（艺术）是工程判定的病根，"
              "把知识写进产物（工程）是经济判定的病根。"),
    "sources": [
        ("经济学 · 不完全契约与剩余控制权",
         "Hart &amp; Moore, Property Rights and the Nature of the Firm (JPE 98:6, 1990)；"
         "另见 Grossman &amp; Hart (JPE 94:4, 1986)；Hart, Firms, Contracts and Financial Structure (OUP 1995)",
         "https://doi.org/10.1086/261729",
         "主张合约在原理上写不全，故决定投资激励的不是条款而是「合约沉默处谁说了算」；"
         "而这一支自己承认，「不可缔约」的范围随技术而移动——它不是属性，是一个浮动的余数。"),
        ("艺术学 · 能动性的推断与观看技能的历史性",
         "Gell, Art and Agency (Oxford, 1998)；Baxandall, Painting and Experience in "
         "Fifteenth Century Italy (Oxford, 1972)",
         "https://global.oup.com/academic/product/painting-and-experience-in-fifteenth-century-italy-9780198813583",
         "盖尔主张作品靠观者从物上倒推出制作的能动性而起作用；巴克森德尔给出这项推断所需技能的来源——"
         "它由估算容积、辨识舞姿、听懂手势这些与艺术无关的日常实践顺带养成。后一条正是推翻共有前提的材料。"),
        ("工程学 · 编程即理论建构与软件演化",
         "Naur, Programming as Theory Building (Microprocessing and Microprogramming 15:5, 1985)；"
         "另见 Lehman, Programs, Life Cycles, and Laws of Software Evolution (Proc. IEEE 68:9, 1980)",
         "https://doi.org/10.1016/0165-6074(85)90032-8",
         "主张程序真正的所在是建造者头脑中的理论，文档只是不完整投影；"
         "而瑙尔自己写明理论可由新人经与持有者共同工作而获得——即它长在干活这件事里，是副产品。"),
    ],
}]
