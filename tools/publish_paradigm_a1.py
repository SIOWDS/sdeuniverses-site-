...
PAPERS = [
    ...
    },
    {
        ...
        "hook": "一门茶道，培训体系越完整、认证越精密，后人达到的深度反而越浅；"
                "一部法律，法条一字未改、程序无瑕扣合，却已经不能让任何一个执行它的人为它失眠；"
                "一句家训，把一个父亲二十年的具体挫败压缩成八个字，一千年里被无数不相干的人重新用上。"
                "本文论证：能被传下去的不是完整的东西，是带着一处必须由接手者亲自补上的缺口的东西；"
                "而所有认真的保存工作，做的第一件事恰恰是把那个空格填上。",
        "sources": [
            {"t": "自我复制的悖论：精神实践效能衰减的内生机制",
             "u": "/students/hu-zhiying/efficacy-attrition/",
             "d": "技艺传承 · 制度化既是保存装置也是消耗装置",
             "who": "胡志英", "who_url": "/students/hu-zhiying/"},
            {"t": "裂隙自续：为什么法律的死不是被推翻，而是不再生长",
             "u": "/students/gao-peng/fissure-self-continuation/",
             "d": "法哲学 · 只要不被技术性理由缝合，它自己会活",
             "who": "高鹏", "who_url": "/students/gao-peng/"},
            {"t": "沉淀的形态：伦理生活的「过后」与「之前」",
             "u": "/students/zhang-qiong/sedimented-layer/",
             "d": "伦理人类学 · 被误认为死掉的硬壳，才是骨骼",
             "who": "张琼", "who_url": "/students/zhang-qiong/"},
        ],
        "collide": "三篇正面打架：第一篇说保存就是消耗——制度化最成功的体系衰减最显著；"
                   "第二篇说别去补它、那道裂隙不被缝合就会自己活；"
                   "第三篇说必须硬化、必须压缩成可记诵的格言，否则根本传不过断裂带。"
                   "而格言正是一种极致的缝合：它把二十年压成八个字，什么具体的都没留下。"
                   "九个判断两两相撞三十六次，撞出的是三篇里谁都没有说过的第四样东西。",
    },
    {
        "src": "A6", "no": 24, "slug": "late-ruler",
        "title": "所有的尺子都来得太晚",
        "subtitle": "你手里那把尺子量到的东西里，有一部分是你自己放进去的；而它到场太晚，晚到看不见自己放过",
        "hook": "一位老师的目光在某个学生身上多停了不到一秒——那时她还来不及做任何判断；"
                "一位妻子发现丈夫的体贴无可挑剔，却再也不会在深夜说出「我也不太会爱」；"
                "一个人被算出一个分数，此后每一次决断都能流畅地引用它。"
                "本文论证：用来判断一个人的所有尺子，都在结果成形之后才到场，"
                "而它们量到的东西，测量者自己也参与造过；于是结果被读成原因，"
                "参与制造的那一侧从记录里整个消失。",
        "sources": [
            {"t": "偏折的源头：教学互动中能力差异的共构动力学",
             "u": "/students/chen-xiaoyan/co-frequential-deflection/",
             "d": "教育互动 · 差异是几秒钟的来回共同造出来的",
             "who": "陈晓艳", "who_url": "/students/chen-xiaoyan/"},
            {"t": "爱的他手性：亲密关系根基的一个生成假说",
             "u": "/students/qin-li/other-handedness/",
             "d": "亲密关系 · 那样东西只能从对方体内长出来",
             "who": "秦莉", "who_url": "/students/qin-li/"},
            {"t": "数字是骨头：为什么拆掉风险评分的所有理由，却仍然拆不掉它",
             "u": "/students/gao-peng/score-as-bone/",
             "d": "算法治理 · 痕迹已经替代了人本身",
             "who": "高鹏", "who_url": "/students/gao-peng/"},
        ],
        "collide": "三篇正面打架：第一篇说差异不是先在的，在任何人相信什么之前就已被互动造出来；"
                   "第二篇说有些东西确确实实只能从那个具体的人身上长出来、换个人就不出现；"
                   "第三篇说这些争论都晚了，因为一个人的数字痕迹早已替代他成为制度操作的本体。"
                   "而第一篇会反问第二篇：「你手上有没有」这个问法，"
                   "本身就把一台双人机器的产物记成了他一个人的存货。"
                   "九个判断两两相撞三十六次，撞出的是三篇里谁都没有说过的第四样东西。",
    },
    {
        "src": "A5", "no": 23, "slug": "one-way-good",
        "title": "最深的覆盖，看起来像不干涉",
        "subtitle": "判断一次接触是养人还是覆盖人，不看你动没动手，看这次之后你自己变没变",
        "hook": "一片被拆掉的急诊室雨棚、一场刻意不去拆对方旧信念的谈话、"
                "一个秦代农民在情绪涌上来之前硬生生停住的那一下——三件毫不相干的事，"
                "指向同一个被长期用错的判据。我们习惯用「有没有强加」来判断一段关系，"
                "而本文论证：一切「我给你」「我护着你」「我不动你」是同一类，"
                "而最深的一种覆盖恰恰长着不干涉的样子。判据只有三问，问的都是施与的那一方。",
        "sources": [
            {"t": "那双相互改写的手：建筑学的发生学转向",
             "u": "/students/putao/hands-that-rewrite-each-other/",
             "d": "建筑发生学 · 必须互相进入，痕迹是唯一存证",
             "who": "葡萄", "who_url": "/students/putao/"},
            {"t": "引力的形状：当一场对话不拆壳，只改变引力中心",
             "u": "/students/putao/gravitational-dialogue/",
             "d": "对话哲学 · 什么都别动，站在旁边就够了",
             "who": "葡萄", "who_url": "/students/putao/"},
            {"t": "辟思：一种理解中华民族思想变迁的「心灵飞地」假说",
             "u": "/students/putao/mind-enclave/",
             "d": "中国思想史 · 得先隔开，谁也别进来",
             "who": "葡萄", "who_url": "/students/putao/"},
        ],
        "collide": "三篇正面打架：第一篇说不互相写入就等于没发生、痕迹不是损坏；"
                   "第二篇说一切进入都携带控制，真正有效的是在旁边站着而不动手；"
                   "第三篇说还没成形的判断必须先隔开，被写入就等于被熨平。"
                   "而第一篇会反问第二篇：在旁边站着的那个人，自己什么也没变，这算相互吗？"
                   "九个判断两两相撞三十六次，撞出的是三篇里谁都没有说过的第四样东西。",
    },
    {
        "src": "A4", "no": 17, "slug": "three-kinds-of-first",
        "title": "有些本事，是准备不出来的",
        "subtitle": "三种「必须先」，只有一种排得进日程表；而加大准备，恰好是挤掉另外两种的那个动作",
        "hook": "一个孩子的日程排得滴水不漏，几年下来没有一件事是他自己想弄明白的；"
                "两个学生用同样的三小时解同一道题，一个人的三小时留下了东西，另一个结束就结束了；"
                "一位医生面对一堆不肯收敛的症状，必须现在就给一个没有依据的说法。"
                "本文把「先」拆成三种——**排得出的先**（顺序，可安排）、"
                "**等得到的先**（必须真实经过，且经过得算数）、**撞得着的先**（在没有依据时先下的那一刀）——"
                "并论证三者是串联的、三种缺失长得一模一样、而唯一的通用药方只对第一种有效。",
        "sources": [
            {"t": "来不及构成：批判理论的时间盲区，与「构成时序律」",
             "u": "/students/putao/constitutive-timing/",
             "d": "时间社会学 · 顺序可安排，护住窗口就能长",
             "who": "葡萄", "who_url": "/students/putao/"},
            {"t": "厚度的发生：为什么「成为动词」之后，天赋仍然卡在时间里",
             "u": "/students/chen-xiaoyan/time-thickness/",
             "d": "教育与天赋研究 · 窗口开着照样有人每轮清零",
             "who": "陈晓艳", "who_url": "/students/chen-xiaoyan/"},
            {"t": "重识同一：从辨识的承重到辨识的倒逼",
             "u": "/students/hu-zhiying/identificatory-closure/",
             "d": "认识论与诊断史 · 连该准备什么都不能先知道",
             "who": "胡志英", "who_url": "/students/hu-zhiying/"},
        ],
        "collide": "三篇正面打架：第一篇说决定成败的是时序编排、且可以工程化；"
                   "第二篇说编排对了、窗口开着，同样一段时间在有的人身上照样清零，"
                   "决定的是时间的质地而非顺序；第三篇说前两者都预设了我们知道要长什么，"
                   "而在真正要紧的现场规律尚未成形——辨识不是迟到的见证，是结构性早到。"
                   "九个判断两两相撞三十六次，撞出的是三篇里谁都没有说过的第四样东西。",
    },
    {
