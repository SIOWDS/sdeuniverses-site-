...
const DIST_WORDS = { essay: 3000, paper1: 20000, paper: 20000, wechat: 3000, prose: 5000, story: 2400, novella: 24000, novel: 100000, poem: 500,
  script: 6000,
  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/wds/distill") {
      ...
      const SPEC = {
        ...
        novel: { name: "长篇小说（10万字·四部）", tok: 12000, noHead: 1, parts: 16, world: 1, threads: 1, timeline: 1, fixed: [
          ...
          "把这场对话里那个判断，写成一部【长篇小说，约 10 万字，分四部】。\n"
          + "承重物在这一档是**演出**的：判断**绝不出面**，由情节自己撞出来。\n"
