  ...
  if (deep) {
    ...
    // ===== 模式：最终综合提炼（涌现流水线末环，也是整条产线最要紧的一步）=====
      ...
      if (mode === "polish") {
        ...
        sys = base
          + "本篇分五段连续写成，本次写【" + PART_NAME[P] + "】（共五段，两万字）。"
