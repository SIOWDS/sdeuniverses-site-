...
const WDS_PROFILES = {
  ...
  math: {
    ...
    who: "小波老师（李昕）",
    domain: "数学 · 数学学习 · 数学教学",
    home: "https://math.sdeuniverses.com/",
    all: "https://math.sdeuniverses.com/all/",
    sys: XIAOBO_SYS,
