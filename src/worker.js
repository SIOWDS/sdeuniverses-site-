...
const JOHN_COMPOSE = {
  ...
  essay:  { parts: 3, per: 1700, label: "散文", total: "约五千字" },
...
const DIST_WORDS = { essay: 3000, paper1: 20000, paper: 20000, wechat: 3000, prose: 5000, story: 2400, poem: 500,
  script: 6000,
  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/wds/distill") {
      ...
      const kind = ({ report: 1, essay: 1, outline: 1, deck: 1, paper: 1, paper1: 1, sumdoc: 1,
                      wechat: 1, prose: 1, story: 1, poem: 1, script: 1,
      ...
      const SPEC = {
        ...
        prose: { name: "散文（5000字）", tok: 20000, noHead: 1, parts: 3, fixed: [
        ...
        story: { name: "短篇小说（2400字）", tok: 10000, noHead: 1, parts: 2, fixed: [
