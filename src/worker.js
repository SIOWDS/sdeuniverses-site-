  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/wds/distill") {
      ...
      const kind = ({ report: 1, essay: 1, outline: 1, deck: 1, paper: 1, paper1: 1, sumdoc: 1,
                      wechat: 1, prose: 1, story: 1, poem: 1 })[b.kind] ? b.kind : "report";
      ...
      const SPEC = {
        ...
        wechat: { name: "公众号文章（3000字）", tok: 12000, spec:
        ...
        prose: { name: "散文（5000字）", tok: 20000, spec:
        ...
        story: { name: "短篇小说（2000字）", tok: 10000, spec:
          "把这场对话里那个判断，写成一篇【短篇小说，2000 字起，可到 4000 字】。\n"
