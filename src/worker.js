...
const JOHN_COMPOSE_SPEC = {
  ...
  essay:
    ...
    "**通篇不许出现任何术语**——连「形式／用法／场合」这三个词也少用，道理要藏在事情里，" +
    ...
    if (url.pathname === "/api/wds/distill") {
      ...
      const SPEC = {
        ...
        wechat: { name: "公众号文章（3000字）", tok: 12000, spec:
          ...
          + "① **开头三句之内必须出现一个具体场面**（一个人、一句话、一个动作）——抓不住就没人往下读。不许从定义、从「随着……的发展」起手。\n"
          + "② 用小标题分成四到六段，每段不超过五行；多用短句，少用从句。\n"
          + "③ 全篇只讲**一个判断**，反直觉、说得清；其余材料都为它服务，讲不完的宁可删。\n"
          + "④ 术语最多两个，出现就当场用大白话解释一句。\n"
          + "⑤ **结尾给一个明天就能做的动作**，具体到能照着做，不喊口号、不煽情、不写「你学会了吗」这类互动尾巴。\n"
          + "⑥ 不出现「读者问」「本次对话」之类痕迹。用 Markdown，标题用 # 与 ##。" },
        prose: { name: "散文（5000字）", tok: 20000, spec:
          "把这场对话写成一篇【散文，约 5000 字】。**不讲道理，讲经验。**\n"
          + "① 从一个具体的场景、一个人、一句话开始，让读者先看见，再明白。可以有天气、有声音、有当时的犹豫。\n"
          + "② 道理要**藏在事情里**——凡是能用一个场面说的，就不要用一句判断说。读者读完自己想到，比你说出来强。\n"
          + "③ 句子要有长短，段落要有呼吸；允许闲笔，但每一处闲笔都要在后面还回来。\n"
          + "④ **通篇不许出现术语**，也不要分点罗列、不要小标题式的说理骨架。\n"
          + "⑤ 不写结论段、不写「总之」，在一个具体的画面上收住。\n"
          + "⑥ 不出现「读者问」「本次对话」之类痕迹。第一行是标题本身。" },
        story: { name: "短篇小说（2000字）", tok: 10000, spec:
          "把这场对话里那个判断，写成一篇【短篇小说，约 2000 字】。**不要写成寓言，也不要在结尾点题。**\n"
          + "① 只要一个场景、一到三个人物、一段不长的时间。**从事情已经开始的地方进去**，不交代前情。\n"
          + "② 那个判断**必须由情节自己撞出来**：写一件事，让它在人物之间发生。凡是人物开口说出道理的地方，一律删掉重写成动作或沉默。\n"
          + "③ 对话要各有各的口吻，一个人说的话换到另一个人嘴里应当立刻不像。\n"
          + "④ 细节要具体、可感、有出处（一件物、一处光、一个习惯动作），不要形容词堆叠。\n"
          + "⑤ **结尾不解决、不总结**——在一个动作或一个物件上停住，把余味留给读者。\n"
          + "⑥ 不出现任何议论段、不写题记、不写作者的话。第一行是小说标题。" },
