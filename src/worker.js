...
const DECK_TPL = {
  /* ═══ 简单档 6 套 ═══ */
  brief: { name: "工作汇报", theme: "slate", tier: "简单", pages: "9–12", spec:
  ...
  research: { name: "研究汇报", theme: "ink", tier: "简单", pages: "10–14", spec:
    "【研究汇报】听众是同行，会追问方法与反例。\n"
  ...
  teach: { name: "教学讲义", theme: "forest", tier: "简单", pages: "10–14", spec:
    "【教学讲义】目标是让人学会，不是让人佩服。\n"
  ...
  review: { name: "复盘总结", theme: "plum", tier: "简单", pages: "9–12", spec:
  ...
  proposal: { name: "方案建议", theme: "sea", tier: "简单", pages: "9–12", spec:
  ...
  onepage: { name: "一页纸摘要", theme: "clay", tier: "简单", pages: "5–7", spec:
  ...
  /* ═══ 中等档 7 套：染色底＋淡底纹 ═══ */
  pitch: { name: "路演提案", theme: "sand", tier: "中等", pages: "9–12", spec:
  ...
  product: { name: "产品发布", theme: "mist", tier: "中等", pages: "10–13", spec:
    ...
    + "语气：不吹、用动词、每条都能被验证。" },
  train: { name: "培训课件", theme: "moss", tier: "中等", pages: "12–14", spec:
    ...
    + "语气：命令式、可执行、每条都能当场做。" },
  health: { name: "健康科普", theme: "celadon", tier: "中等", pages: "9–12", spec:
  ...
  edu: { name: "家校沟通", theme: "blush", tier: "中等", pages: "9–12", spec:
  ...
  data: { name: "数据解读", theme: "steel", tier: "中等", pages: "10–13", spec:
  ...
  cases: { name: "案例分析", theme: "amber", tier: "中等", pages: "10–13", spec:
    "【案例分析】一个具体的事，讲透比讲全重要。\n"
  ...
  talk: { name: "观点演讲", theme: "midnight", tier: "复杂", pages: "8–11", spec:
  ...
  keynote: { name: "主题演讲", theme: "royal", tier: "复杂", pages: "10–13", spec:
  ...
  vision: { name: "战略愿景", theme: "indigo", tier: "复杂", pages: "10–13", spec:
  ...
  brandstory: { name: "品牌故事", theme: "wine", tier: "复杂", pages: "9–12", spec:
    ...
    + "⑨ 一句话收束：只写 1 条。⑩ 末页「下一步」。\n"
    + "语气：叙事、有人称、不喊口号。" },
  award: { name: "成果汇报", theme: "jade", tier: "复杂", pages: "10–13", spec:
    ...
    + "语气：有一说一；**未验证的不许写成已验证**。" },
  launch: { name: "发布会", theme: "sunset", tier: "复杂", pages: "9–12", spec:
    ...
    + "⑩ 末页「下一步」：一句话号召。\n"
    + "语气：短促、有停顿；不许出现参数表。" },
  story: { name: "叙事汇报", theme: "carbon", tier: "复杂", pages: "10–13", spec:
    ...
    if (url.pathname === "/api/wds/distill") {
      ...
      const SPEC = {
        ...
        deck: { name: "对外 PPT", tok: WDS_TOK_MAX, spec:
          ...
          + "【装配三原则：美＝统一·多样·和谐。渲染端管几何，你管内容的形状，缺一不可】\n"
          + "· **统一**：全套只用一套语法——每页标题都是一句判断（不是话题词）、每条要点都是判断句、"
          + "同一个概念全套用同一个词（别一会儿叫「路径」一会儿叫「通道」）。读者翻十页，要看得出是同一个人写的。\n"
          + "· **多样**：**相邻两页不许写成同一个形状**。上一页是三条要点，下一页就该是数字对／成对对照／步骤／一句话／引文之一。"
          + "同一种形状连着写三页，等于把听众催眠。\n"
          + "· **和谐**：每页只推进一步，条数与字数守住呼吸——**宁可少一条，不许挤**；"
          + "一页里不要同时塞对比又塞数字又塞步骤（那是三页的量）；每页讲稿都要接得上上一页的最后一句。\n"
          + "【内容要求】\n"
