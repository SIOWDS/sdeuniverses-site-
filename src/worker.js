  ...
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === "/api/wds/distill") {
      ...
      const PAPER_SKELETON = [
        ...
        { h: "四、核心命题：承重判断的提出", words: 1400, ask:
        ...
        { h: "六、可裁决判据与可观测指标", words: 1400, ask:
        ...
        { h: "九、分析（一）：竞争解释的检验", words: 1500, ask:
        ...
        { h: "十、分析（二）：类型学与辨别格", words: 1400, ask:
