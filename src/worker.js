  ...
  if (deep) {
    ...
    // ===== 模式：最终综合提炼（涌现流水线末环，也是整条产线最要紧的一步）=====
      ...
      const base = (neigong
        ...
        + (brief
            ? "\n\n【本篇的起点是那份《论文入口资料》——它是清单，不是参考】资料里的第三栏（候选承重命题）是你的起跑线而不是终点线；第四栏（反复被触到的分离点）必须至少有两条进正文并写成可裁决形态；第五栏〔应当交手而尚未交手的最近邻〕里点名的人，至少两位要在正文里指名道姓正面交手，其中至少一位是外文占位者；第六栏（尚未解决的张力）必须逐条正面处理，不许绕过；第八栏里标为〔站内自引〕或〔未核验〕的材料，一律不得当作已证实的事实去支撑被解释项，要用就写明它的证据等级。但这份资料只是入口——论文的核心判断必须比它再往前走一步，把它扩写成文即为不合格。"
            : "")
