    ...
    if (url.pathname === "/api/wds/distill") {
      ...
      const PAPER_SKELETON = [
        { h: "摘要与关键词", words: 1100, ask:
          "本节交付四件，缺一不可，按序写，不写别的：① 单起一行 `**Title:** 英文题名`（与中文题名对应而非逐字直译）；"
          ...
          + "铁律：摘要里承诺过的每一项（判据、类型学、证伪条款、附录）正文都必须兑现，兑现不了就现在别写进摘要。" },
        { h: "一、引言：研究问题与研究意义", words: 1300, ask:
        ...
        { h: "三、理论框架与概念界定", words: 1500, ask:
          "3.1 理论出发点——本文站在哪个理论传统上，以及为什么是它而不是替代者；"
          + "3.2 **名义定义**：核心概念一句话，**不含程度词**（不许出现「充分」「真正」「实质性」「恰当」「合理」）；"
          + "3.3 **操作性定义**：它在经验层面表现为什么、由哪一个读数承载、测量层次是什么（类别／顺序／等距／等比）；"
          + "3.4 概念辨异：与三个最接近的同族概念逐条辨异，写清差在哪一处。"
          + "借另一门学科的术语当承重概念之前，先查清它在原学科内部最接近的两三个同族词，确认要的正是这一个"
          + "（失认 agnosia／病感失认 anosognosia／肢体失认 asomatognosia 指的不是一回事）——选错同族词等于承重概念本身选错。" },
        { h: "四、研究设计与方法", words: 1600, ask:
          "**判据只有一条：别人照着这一节做，能不能得到同一结果。** 五件齐全："
          + "4.1 方法论立场与研究类型（概念分析／案例研究／历史比较／文本分析……），并说明为何是它而非替代方案；"
          + "4.2 材料来源与取样——材料从哪儿来、覆盖什么范围、按什么标准纳入与排除、共多少件；"
          + "4.3 分析程序——逐步写、能复现；编码类须给编码单元、编码表来源、编码轮次；"
          + "4.4 信度与研究者立场——编码一致性怎么保证，单人编码就明说是单人，并交代研究者自身立场可能带来的偏向；"
          + "4.5 研究伦理——涉人材料的知情同意、匿名化与审查批号；不涉人也要写一句「本研究不涉及人类被试」。" },
        { h: "五、分析（一）：竞争解释的检验", words: 1500, ask:
          "⚠ **分析节只出结果、不出意义解读**（解读留给第十一节讨论）——这是审稿人最容易抓的一条。"
          + "逐节拆开第二章每一位占位者手里的解释变量，各给一个**它解释不了的具体现象**，"
          + "并把分离点写成可裁决形态：当⟨具体条件⟩时，它预测 A，本文预测 B，而 A 与 B 分别怎么读数。"
          + "只写「本文更强调／更深入／更系统／视角不同」一律不算分离——那些话不可判定，等于承认自己被覆盖了。" },
        { h: "六、分析（二）：核心命题的提出", words: 1400, ask:
          "把承重命题正式立起来，写成「X 不是 Y₁、也不是 Y₂，而是 Z」这一形状；"
          + "说清 Z 在什么条件下成立、在什么条件下不成立；给出 Z 的成立判定条件，逐条列。"
          + "并做一次**两句复合测试**：若本命题能被两句现成文献拼起来无损重述，就在这里承认这一点，并说明增量究竟落在哪一处，"
          + "不得让读者以为整体都是新的。" },
        { h: "七、分析（三）：类型学与辨别格", words: 1500, ask:
          "7.1 候选轴的排除——至少排除两个候选并说明理由；**凡候选轴是核心变量的成因，一律排除**（拿成因当第二轴等于自己跟自己相关）；"
          + "7.2 第二轴的确立——须举出一个两轴同时为高的具名真实案例；举不出就不许写「正交」「结构独立」，"
          + "改写成「相关但不重合」并说明协变方向；"
          + "7.3 二维辨别格——四格逐格分条，每格单独一段，段首先写两个坐标值，再写格内描述，最后给一条**只在该格成立**的预测。"
          + "四格两两比对，不得有两格落在同一组合上；给不出独有预测的格子直接删掉。" },
        { h: "八、可裁决判据与可观测指标", words: 1400, ask:
          "8.1 判别式：一条会让第二章每一位占位者预测相反的判据，**不含情态词**（禁用：应当／有意义／实质性／充分／真正／恰当／合理）——"
          + "它要能拿去问流程、日志、记录，而不是拿去问人的判断；并在三到五个具体场景各跑一遍，答案要互不相同；"
          + "8.2 可观测指标：怎么测、测什么、多少算数、多大差异才算数；"
          + "8.3 误诊阻挡：哪些情形读数相同却不属于本文所指。" },
        { h: "九、稳健性检验与证伪条件", words: 1500, ask:
          "三到六条证伪条款，彼此独立、分属不同检验路径。每条写清：去看什么／看到什么就算本文错了／为什么现有解释预测不出这一结果。"
          + "其中**至少一条须是「今天就能查」的，并在正文里当场交出你这次执行的结果**——"
          + "查了哪些国家、哪段历史、哪类已发表统计，命中了什么，或到什么范围为止仍未命中。"
          + "**不许只描述检索式然后断言「检索必然落空」「至今没有任何一例」**：断言全称否定之前先自己跑一遍，"
          + "跑不动就写成「就本文已核验的范围而言，尚未见到」。跑过的检验，不利的那一次也要报。" },
        { h: "十、与既有研究的对话与划界", words: 1400, ask:
          "至少四条，逐条写：那家说到哪一步／分离线在哪／一个**判决性对照预测**"
          + "（同一个案例，按它判是 A、按本文判是 B，A 与 B 各自怎么读数）。"
          + "第二章请进来过的人，这里都要给出那句可裁决差异——请进来却不写差异，等于没请。"
          + "⚠ 「本文更强调／更深入／更系统／更全面／视角不同」一律不算划界。" },
        { h: "十一、讨论", words: 1300, ask:
          "⚠ **讨论节只解读、不出新证据**（新证据一律回到第五至七章）。四件："
          + "11.1 理论意涵；11.2 实践意涵；11.3 适用边界与反向约束——本文主张在什么条件下不成立，至少两条，"
          + "并说明它们各削掉了本文原本想说的哪一句；11.4 一条**反噬**——若照本文去做，最省事的做法会不会恰好毁掉它想保住的东西。" },
        { h: "十二、效度威胁与研究局限", words: 1000, ask:
        ...
        { h: "十三、结论与研究启示", words: 800, ask:
          "收口：回答引言里那几条 RQ，逐条对上；给出研究启示。"
        ...
        { h: "参考文献与附录", words: 1300, ask:
          ...
          + "【附录 A　编码手册】与【附录 B　读数清点规程】：把第八章那个可观测指标写成别人能照着做的规程——"
          + "单位、粒度、编码规则、边界情形。" },
      ];
      const SPEC = {
